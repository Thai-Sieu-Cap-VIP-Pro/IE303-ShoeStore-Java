          ...
          <Row>
            ...
            <Col sm={6}>
              <nav class="woocommerce-breadcrumb breadcrumbs">
                ...
                <a href="nu/classic-nu/">Classic</a>
              </nav>
              <h1 class="product-title product_title entry-title">
                {DetailProduct.product_name}
              </h1>
              <h3 class="ps-product__price">{DetailProduct.product_price}</h3>
              ...
              <ul class="nav nav-tabs">
                ...
                <p>
                  - Đế cao su mềm, êm ái giúp bạn cảm thấy dễ chịu khi di chuyển
                  trong thời gian dài. Thêm vào đó, giày thể thao nữ MWC NUTT-
                  0698 có tính năng thoáng khí, giúp cân bằng nhiệt và độ ẩm
                  trong những điều kiện môi trường khác nhau. - Sản phẩm hướng
                  theo phong cách hiện đại, khỏe khoắn, màu sắc trẻ trung phù
                  hợp với nhiều lứa tuổi và dáng người. - Đường may tỉ mỉ, tinh
                  tế tạo cho bạn cảm giác yên tâm về chất lượng. - Sản phẩm có
                  tính ứng dụng cao: thích hợp mang khi tập luyện thể thao, đi
                  làm, đi chơi và tham gia các hoạt động thường ngày...
                </p>
              </ul>
            </Col>
          </Row>
